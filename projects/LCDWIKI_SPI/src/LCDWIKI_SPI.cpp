...
void LCDWIKI_SPI::Set_Addr_Window(int16_t x1, int16_t y1, int16_t x2, int16_t y2)
{
	...
	if(lcd_driver == ID_932X) 
	{
	    ...
	    // Values passed are in send_current_bit (possibly rotated) coordinate
	    ...
	    // done in any direction, the send_current_bit screen rotation is applied
